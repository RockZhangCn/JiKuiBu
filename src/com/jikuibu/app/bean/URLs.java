...
public class URLs implements Serializable {
	...
	public final static String HOST = "10.88.23.170";//192.168.1.213  www.oschina.net
	 ...
	 * è½¬åŒ–URLä¸ºURLså®žä½“
	 * @param path
	 * @return ä¸�èƒ½è½¬åŒ–çš„é“¾æŽ¥è¿”å›žnull
	 */
		...
		try {
			...
			if(url.getHost().contains(URL_HOST)){
				...
				if(path.contains(URL_WWW_HOST )){
					//æ–°é—»  www.oschina.net/news/27259/mobile-internet-market-is-small
					...
					//é—®ç­”
						...
						//é—®ç­”-æ ‡ç­¾  http://www.oschina.net/question/tag/python
						...
						//é—®ç­”  www.oschina.net/question/12_45738
						else{
				...
				//my
					...
					//ä¸ªäººä¸“é¡µ  my.oschina.net/u/12
						...
						//å�¦ä¸€ç§�ä¸ªäººä¸“é¡µ  my.oschina.net/dong706
